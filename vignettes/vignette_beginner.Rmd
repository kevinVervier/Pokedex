...
print(paste('Accuracy on the training set:',round(1-(fit.rf()$confusion[1,2] + fit.rf()$confusion[2,1])/nrow(train.df),2),'\n'))
})
```
...
print(paste('Accuracy on the validation set:',round(sum(preds==val.df$type_1)/nrow(val.df),2),'\n'))
})
